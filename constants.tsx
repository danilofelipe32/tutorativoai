...
export const actionConfig: ActionConfig = {
    [ActionType.SUMMARIZE]: {
        ...
        icon: SummarizeIcon,
        className: 'bg-blue-100/70 dark:bg-blue-900/30 border border-blue-300/80 dark:border-blue-500/50 hover:bg-blue-200/70 dark:hover:bg-blue-500/30 hover:shadow-lg hover:shadow-blue-500/20 dark:hover:shadow-blue-500/40 backdrop-blur',
    },
    [ActionType.KEYWORDS]: {
        title: 'Termos-Chave',
        description: 'Extrai e define os conceitos mais importantes.',
        icon: KeywordsIcon,
        className: 'bg-emerald-100/70 dark:bg-emerald-900/30 border border-emerald-300/80 dark:border-emerald-500/50 hover:bg-emerald-200/70 dark:hover:bg-emerald-500/30 hover:shadow-lg hover:shadow-emerald-500/20 dark:hover:shadow-emerald-500/40 backdrop-blur',
    },
    [ActionType.REFLECT]: {
        title: 'Para Refletir',
        description: 'Gera perguntas para estimular o pensamento crítico.',
        icon: ReflectIcon,
        className: 'bg-purple-100/70 dark:bg-purple-900/30 border border-purple-300/80 dark:border-purple-500/50 hover:bg-purple-200/70 dark:hover:bg-purple-500/30 hover:shadow-lg hover:shadow-purple-500/20 dark:hover:shadow-purple-500/40 backdrop-blur',
    },
    [ActionType.TEST]: {
        title: 'Testar Conhecimento',
        description: 'Cria um quiz para avaliar sua compreensão.',
        icon: TestIcon,
        className: 'bg-amber-100/70 dark:bg-amber-900/30 border border-amber-300/80 dark:border-amber-500/50 hover:bg-amber-200/70 dark:hover:bg-amber-500/30 hover:shadow-lg hover:shadow-amber-500/20 dark:hover:shadow-amber-500/40 backdrop-blur',
    },
    [ActionType.SIMPLIFY]: {
        title: 'Simplificar Texto',
        description: 'Traduz seções complexas para uma linguagem fácil.',
        icon: SimplifyIcon,
        className: 'bg-rose-100/70 dark:bg-rose-900/30 border border-rose-300/80 dark:border-rose-500/50 hover:bg-rose-200/70 dark:hover:bg-rose-500/30 hover:shadow-lg hover:shadow-rose-500/20 dark:hover:shadow-rose-500/40 backdrop-blur',
    },
    [ActionType.MINDMAP]: {
        title: 'Criar Mapa Mental',
        description: 'Organiza o conteúdo em uma estrutura visual.',
        icon: MindmapIcon,
        className: 'bg-sky-100/70 dark:bg-sky-900/30 border border-sky-300/80 dark:border-sky-500/50 hover:bg-sky-200/70 dark:hover:bg-sky-500/30 hover:shadow-lg hover:shadow-sky-500/20 dark:hover:shadow-sky-500/40 backdrop-blur',
    },
    [ActionType.ANALOGY]: {
        title: 'Criar Analogia',
        description: 'Explica um tópico usando uma analogia simples.',
        icon: AnalogyIcon,
        className: 'bg-indigo-100/70 dark:bg-indigo-900/30 border border-indigo-300/80 dark:border-indigo-500/50 hover:bg-indigo-200/70 dark:hover:bg-indigo-500/30 hover:shadow-lg hover:shadow-indigo-500/20 dark:hover:shadow-indigo-500/40 backdrop-blur',
    },
    [ActionType.STEP_BY_STEP]: {
        title: 'Passo a Passo',
        description: 'Detalha um processo em etapas sequenciais.',
        icon: StepByStepIcon,
        className: 'bg-teal-100/70 dark:bg-teal-900/30 border border-teal-300/80 dark:border-teal-500/50 hover:bg-teal-200/70 dark:hover:bg-teal-500/30 hover:shadow-lg hover:shadow-teal-500/20 dark:hover:shadow-teal-500/40 backdrop-blur',
    },
    [ActionType.CONNECTIONS]: {
        title: 'Conexões Reais',
        description: 'Conecta o tema com o mundo real e outras áreas.',
        icon: ConnectionsIcon,
        className: 'bg-orange-100/70 dark:bg-orange-900/30 border border-orange-300/80 dark:border-orange-500/50 hover:bg-orange-200/70 dark:hover:bg-orange-500/30 hover:shadow-lg hover:shadow-orange-500/20 dark:hover:shadow-orange-500/40 backdrop-blur',
    },
    [ActionType.DEEPER_QUESTIONS]: {
        ...
        className: 'bg-zinc-200/70 dark:bg-zinc-900/30 border border-zinc-300/80 dark:border-zinc-500/50 hover:bg-zinc-300/70 dark:hover:bg-zinc-500/30 hover:shadow-lg hover:shadow-zinc-500/20 dark:hover:shadow-zinc-500/40 backdrop-blur',
    },
    [ActionType.WEB_SEARCH]: {
        ...
        icon: SearchIcon,
        className: 'bg-gray-200/70 dark:bg-gray-900/30 border border-gray-300/80 dark:border-gray-500/50 hover:bg-gray-300/70 dark:hover:bg-gray-500/30 hover:shadow-lg hover:shadow-gray-500/20 dark:hover:shadow-gray-500/40 backdrop-blur',
    },
    [ActionType.LESSON_PLAN]: {
        title: 'Esboçar Plano de Aula',
        description: 'Estrutura um plano de aula sobre o tópico.',
        icon: LessonPlanIcon,
        className: 'bg-cyan-100/70 dark:bg-cyan-900/30 border border-cyan-300/80 dark:border-cyan-500/50 hover:bg-cyan-200/70 dark:hover:bg-cyan-500/30 hover:shadow-lg hover:shadow-cyan-500/20 dark:hover:shadow-cyan-500/40 backdrop-blur',
    },
    [ActionType.RUBRIC]: {
        title: 'Criar/Converter Rubrica',
        description: 'Gera uma rubrica de avaliação a partir do texto.',
        icon: RubricIcon,
        className: 'bg-yellow-100/70 dark:bg-yellow-900/30 border border-yellow-300/80 dark:border-yellow-500/50 hover:bg-yellow-200/70 dark:hover:bg-yellow-500/30 hover:shadow-lg hover:shadow-yellow-500/20 dark:hover:shadow-yellow-500/40 backdrop-blur',
    },
    [ActionType.DIFFERENTIATION]: {
        ...
        className: 'bg-fuchsia-100/70 dark:bg-fuchsia-900/30 border border-fuchsia-300/80 dark:border-fuchsia-500/50 hover:bg-fuchsia-200/70 dark:hover:bg-fuchsia-500/30 hover:shadow-lg hover:shadow-fuchsia-500/20 dark:hover:shadow-fuchsia-500/40 backdrop-blur',
    },
    [ActionType.DOK_QUESTIONS]: {
        ...
        className: 'bg-lime-100/70 dark:bg-lime-900/30 border border-lime-300/80 dark:border-lime-500/50 hover:bg-lime-200/70 dark:hover:bg-lime-500/30 hover:shadow-lg hover:shadow-lime-500/20 dark:hover:shadow-lime-500/40 backdrop-blur',
    },
    [ActionType.WORKSHEETS]: {
        title: 'Criar Planilhas de Atividades',
        description: 'Gera planilhas de atividades envolventes.',
        icon: WorksheetsIcon,
        className: 'bg-violet-100/70 dark:bg-violet-900/30 border border-violet-300/80 dark:border-violet-500/50 hover:bg-violet-200/70 dark:hover:bg-violet-500/30 hover:shadow-lg hover:shadow-violet-500/20 dark:hover:shadow-violet-500/40 backdrop-blur',
    },
    [ActionType.SOCRATIC_OPPONENT]: {
        ...
        className: 'bg-slate-200/70 dark:bg-slate-900/30 border border-slate-300/80 dark:border-slate-500/50 hover:bg-slate-300/70 dark:hover:bg-slate-500/30 hover:shadow-lg hover:shadow-slate-500/20 dark:hover:shadow-slate-500/40 backdrop-blur',
    },
    [ActionType.PROJECT_IDEAS]: {
        ...
        className: 'bg-cyan-100/70 dark:bg-cyan-900/30 border border-cyan-300/80 dark:border-cyan-400/50 hover:bg-cyan-200/70 dark:hover:bg-cyan-500/30 hover:shadow-lg hover:shadow-cyan-500/20 dark:hover:shadow-cyan-500/40 backdrop-blur',
    },
    [ActionType.EXEMPLARS]: {
        title: 'Exemplos e Não-Exemplos',
        description: 'Cria um exemplo forte e um fraco de uma tarefa.',
        icon: ExemplarsIcon,
        className: 'bg-rose-100/70 dark:bg-rose-900/30 border border-rose-300/80 dark:border-rose-400/50 hover:bg-rose-200/70 dark:hover:bg-rose-500/30 hover:shadow-lg hover:shadow-rose-500/20 dark:hover:shadow-rose-500/40 backdrop-blur',
    },
    [ActionType.CHOICE_BOARD]: {
        title: 'Quadro de Escolhas',
        description: 'Cria um quadro com 9 atividades variadas.',
        icon: ChoiceBoardIcon,
        className: 'bg-pink-100/70 dark:bg-pink-900/30 border border-pink-300/80 dark:border-pink-500/50 hover:bg-pink-200/70 dark:hover:bg-pink-500/30 hover:shadow-lg hover:shadow-pink-500/20 dark:hover:shadow-pink-500/40 backdrop-blur',
    },
    [ActionType.MISCONCEPTIONS]: {
        ...
        className: 'bg-blue-100/70 dark:bg-blue-900/30 border border-blue-300/80 dark:border-blue-400/50 hover:bg-blue-200/70 dark:hover:bg-blue-500/30 hover:shadow-lg hover:shadow-blue-500/20 dark:hover:shadow-blue-500/40 backdrop-blur',
    },
    [ActionType.DISCUSSION_PROMPTS]: {
        ...
        className: 'bg-indigo-100/70 dark:bg-indigo-900/30 border border-indigo-300/80 dark:border-indigo-400/50 hover:bg-indigo-200/70 dark:hover:bg-indigo-500/30 hover:shadow-lg hover:shadow-indigo-500/20 dark:hover:shadow-indigo-500/40 backdrop-blur',
    },
    [ActionType.INFORMATIONAL_TEXT]: {
        ...
        className: 'bg-emerald-100/70 dark:bg-emerald-900/30 border border-emerald-300/80 dark:border-emerald-400/50 hover:bg-emerald-200/70 dark:hover:bg-emerald-500/30 hover:shadow-lg hover:shadow-emerald-500/20 dark:hover:shadow-emerald-500/40 backdrop-blur',
    },
    [ActionType.REAL_WORLD_EXAMPLES]: {
        ...
        className: 'bg-amber-100/70 dark:bg-amber-900/30 border border-amber-300/80 dark:border-amber-400/50 hover:bg-amber-200/70 dark:hover:bg-amber-500/30 hover:shadow-lg hover:shadow-amber-500/20 dark:hover:shadow-amber-500/40 backdrop-blur',
    },
    [ActionType.STORYTELLER]: {
        ...
        className: 'bg-stone-200/70 dark:bg-stone-900/30 border border-stone-300/80 dark:border-stone-500/50 hover:bg-stone-300/70 dark:hover:bg-stone-500/30 hover:shadow-lg hover:shadow-stone-500/20 dark:hover:shadow-stone-500/40 backdrop-blur',
    },
    [ActionType.FACT_CHECKER]: {
        ...
        className: 'bg-red-100/70 dark:bg-red-900/30 border border-red-300/80 dark:border-red-500/50 hover:bg-red-200/70 dark:hover:bg-red-500/30 hover:shadow-lg hover:shadow-red-500/20 dark:hover:shadow-red-500/40 backdrop-blur',
    },
    ...
    [ActionType.POSSIBILITIES_ENGINE]: {
        ...
        className: 'bg-fuchsia-100/70 dark:bg-fuchsia-900/30 border border-fuchsia-300/80 dark:border-fuchsia-400/50 hover:bg-fuchsia-200/70 dark:hover:bg-fuchsia-500/30 hover:shadow-lg hover:shadow-fuchsia-500/20 dark:hover:shadow-fuchsia-500/40 backdrop-blur',
    },
    [ActionType.CO_DESIGNER]: {
        title: 'Co-Designer',
        description: 'Ajuda a planejar atividades de aprendizado personalizadas.',
        icon: CoDesignerIcon,
        className: 'bg-lime-100/70 dark:bg-lime-900/30 border border-lime-300/80 dark:border-lime-400/50 hover:bg-lime-200/70 dark:hover:bg-lime-500/30 hover:shadow-lg hover:shadow-lime-500/20 dark:hover:shadow-lime-500/40 backdrop-blur',
    },
    [ActionType.COLLABORATION_COACH]: {
        ...
        className: 'bg-orange-100/70 dark:bg-orange-900/30 border border-orange-300/80 dark:border-orange-400/50 hover:bg-orange-200/70 dark:hover:bg-orange-500/30 hover:shadow-lg hover:shadow-orange-500/20 dark:hover:shadow-orange-500/40 backdrop-blur',
    },
    [ActionType.EXPLORATORIUM]: {
        title: 'Exploratorium',
        description: 'Facilita a exploração de dados e promove a curiosidade.',
        icon: ExploratoriumIcon,
        className: 'bg-red-100/70 dark:bg-red-900/30 border border-red-300/80 dark:border-red-400/50 hover:bg-red-200/70 dark:hover:bg-red-500/30 hover:shadow-lg hover:shadow-red-500/20 dark:hover:shadow-red-500/40 backdrop-blur',
    },
    ...
    [ActionType.PARETO_PRINCIPLE]: {
        ...
        className: 'bg-green-100/70 dark:bg-green-900/30 border border-green-300/80 dark:border-green-500/50 hover:bg-green-200/70 dark:hover:bg-green-500/30 hover:shadow-lg hover:shadow-green-500/20 dark:hover:shadow-green-500/40 backdrop-blur',
    },
    [ActionType.FEYNMAN_TECHNIQUE]: {
        ...
        className: 'bg-pink-100/70 dark:bg-pink-900/30 border border-pink-300/80 dark:border-pink-400/50 hover:bg-pink-200/70 dark:hover:bg-pink-500/30 hover:shadow-lg hover:shadow-pink-500/20 dark:hover:shadow-pink-500/40 backdrop-blur',
    },
    [ActionType.SIMULATED_DEBATE]: {
        ...
        className: 'bg-gray-200/70 dark:bg-gray-900/30 border border-gray-300/80 dark:border-gray-400/50 hover:bg-gray-300/70 dark:hover:bg-gray-500/30 hover:shadow-lg hover:shadow-gray-500/20 dark:hover:shadow-gray-500/40 backdrop-blur',
    },
    ...
    [ActionType.EVIDENCE_HUNT]: {
        ...
        className: 'bg-stone-200/70 dark:bg-stone-900/30 border border-stone-300/80 dark:border-stone-400/50 hover:bg-stone-300/70 dark:hover:bg-stone-500/30 hover:shadow-lg hover:shadow-stone-500/20 dark:hover:shadow-stone-500/40 backdrop-blur',
    },
    ...
    [ActionType.GENERATE_TWEET]: {
        ...
        className: 'bg-sky-100/70 dark:bg-sky-900/30 border border-sky-300/80 dark:border-sky-400/50 hover:bg-sky-200/70 dark:hover:bg-sky-500/30 hover:shadow-lg hover:shadow-sky-500/20 dark:hover:shadow-sky-500/40 backdrop-blur',
    },
