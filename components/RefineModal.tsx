        ...
        >
            ...
            >
                ...
                <textarea
                    ...
                    className="w-full h-28 bg-slate-900 text-slate-300 p-3 rounded-lg border border-slate-700 focus:outline-none focus:ring-2 focus:ring-sky-500 resize-y"
                ...
                <div className="mt-6 flex items-center justify-end space-x-3">
                    <button 
                        onClick={onClose} 
                        className="bg-slate-600 hover:bg-slate-700 text-white font-bold py-2 px-4 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-slate-800 focus:ring-slate-500"
                    >
                        Cancelar
                    </button>
                    <button 
