...
const DifficultyButton: React.FC<{
    ...
    >
        <p className="font-bold text-lg text-slate-800 dark:text-slate-100">{level}</p>
        ...
        >
            ...
            >
                ...
                <div className="flex items-center mb-4">
                     <TestIcon className="text-2xl text-amber-500 dark:text-amber-400 mr-3" />
                     <h2 className="text-xl font-bold text-slate-900 dark:text-white">Nível do Quiz</h2>
                </div>
                ...
                <div className="space-y-3">
                    <DifficultyButton level="Fácil" color="bg-emerald-100 dark:bg-emerald-500/20 border-emerald-400 hover:bg-emerald-200 dark:hover:bg-emerald-500/30" onClick={onSelectDifficulty} />
                    <DifficultyButton level="Médio" color="bg-sky-100 dark:bg-sky-500/20 border-sky-400 hover:bg-sky-200 dark:hover:bg-sky-500/30" onClick={onSelectDifficulty} />
                    <DifficultyButton level="Difícil" color="bg-rose-100 dark:bg-rose-500/20 border-rose-400 hover:bg-rose-200 dark:hover:bg-rose-500/30" onClick={onSelectDifficulty} />
                </div>
            </div>
        </div>
    );
