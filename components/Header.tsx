    ...
    return (
        <header className="flex items-center justify-between p-3 bg-slate-900/70 border-b border-slate-700 shadow-md flex-shrink-0">
            <div className="flex items-center space-x-2 w-1/3">
                {showBackButton && (
                    <button onClick={onBack} className="p-2 rounded-full hover:bg-slate-700 transition-colors focus:outline-none focus:ring-2 focus:ring-sky-500" title="Voltar">
            ...
            <div className="flex items-center justify-end space-x-2 w-1/3">
                 <button 
                    ...
                    className="p-2 rounded-full hover:bg-slate-700 transition-colors disabled:opacity-30 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-sky-500"
                    title="Refazer"
                >
