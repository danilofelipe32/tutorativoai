...
export const SummarizeIcon = createIcon('lni lni-cut');
export const KeywordsIcon = createIcon('lni lni-key');
export const ReflectIcon = createIcon('lni lni-brain');
export const TestIcon = createIcon('lni lni-list-check');
export const SimplifyIcon = createIcon('lni lni-emoji-friendly');
export const MindmapIcon = createIcon('lni lni-flow-chart');
export const AnalogyIcon = createIcon('lni lni-arrows-horizontal');
export const StepByStepIcon = createIcon('lni lni-list-ol');
export const ConnectionsIcon = createIcon('lni lni-world');
export const DeeperQuestionsIcon = createIcon('lni lni-zoom-in');
export const LessonPlanIcon = createIcon('lni lni-agenda');
export const RubricIcon = createIcon('lni lni-table');
export const DifferentiationIcon = createIcon('lni lni-users');
export const DOKQuestionsIcon = createIcon('lni lni-pyramids');
export const WorksheetsIcon = createIcon('lni lni-printer');
...
export const MisconceptionsIcon = createIcon('lni lni-bug');
export const DiscussionPromptsIcon = createIcon('lni lni-comments');
export const InformationalTextIcon = createIcon('lni lni-notepad');
export const RealWorldExamplesIcon = createIcon('lni lni-factory');
export const StorytellerIcon = createIcon('lni lni-quill-pen');
export const FactCheckerIcon = createIcon('lni lni-shield-check');
export const AIQuestEduIcon = createIcon('lni lni-joystick');
...
export const ExploratoriumIcon = createIcon('lni lni-map');