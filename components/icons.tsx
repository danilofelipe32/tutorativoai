...
export const StepByStepIcon = createIcon('lni lni-cogs');
...
export const ProgressMapIcon = createIcon('lni lni-map');
export const SmartStudyPlanIcon = createIcon('lni lni-calendar');
export const GapDetectorIcon = createIcon('lni lni-invest-monitor');
...
export const IdentifyBiasIcon = createIcon('lni lni-target-alt');